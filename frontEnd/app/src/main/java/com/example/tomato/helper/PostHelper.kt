...
import com.example.tomato.activity.PostActivity
...
import com.example.tomato.helper.commonFunction.byteToURIs
import com.example.tomato.helper.commonFunction.parseLocation
...
object PostHelper {
    ...
    fun showPostActivity(post: PostItemRaw, context: Context){
        val postItem = rawPostToPostItem(post, context)
